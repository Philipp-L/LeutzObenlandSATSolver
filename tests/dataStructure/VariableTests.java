...
public class VariableTests {
	...
	public void testState() {
		...
		variable.assign(true, null, variables, units, new Stack<Variable>(), 0);
		assertEquals(Variable.State.TRUE, variable.getState());
		variable.assign(true, null, variables, units, new Stack<Variable>(), 0);
		assertEquals(Variable.State.TRUE, variable.getState());
		variable.assign(false, null, variables, units, new Stack<Variable>(), 0);
	...
	public void testAssignUnit() {
		...
		units.add(c1);
		v1.assign(true, null, variables, units, new Stack<Variable>(), 0);
	...
	public void testAssignEmpty() {
		...
		assertEquals(c3.initWatch(variables), ClauseState.SUCCESS);
		units.add(c1);
		v1.assign(false, null, variables, units, new Stack<Variable>(), 0);
